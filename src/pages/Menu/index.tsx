  ...
  return (
    <>
      ...
      <ContainerHome>
        <ContainerHomeTitle>
          <h1>
            <strong>{intl.get("head.titulo_negrito")}</strong>{" "}
            {intl.get("head.titulo_normal")}
          </h1>
          <span />
        </ContainerHomeTitle>
        <ContainerHomeCards>
          <Card>
            ...
            <div>
              <p>
                <strong>{intl.get("cards.verba")}</strong> R$ 159.956,76{" "}
      ...
      <ContainerMenuRight>
        <ContIcons>
          ...
          <TextMenuRight>
            <a href="../projects">
              {intl.get("menu_direito.primeiro_botao.primeiro")}
            </a>
            <a href="../projects">
              {intl.get("menu_direito.primeiro_botao.segundo")}
            </a>
          </TextMenuRight>
        </ContIcons>
        <ContIcons>
          ...
          <TextMenuRight>
            <a href="./RegisterProjects">
              {intl.get("menu_direito.segundo_botao.primeiro")}
            </a>
            <a href="./RegisterProjects">
              {intl.get("menu_direito.segundo_botao.segundo")}
            </a>
          </TextMenuRight>
        </ContIcons>
        <ContIcons>
          ...
          <TextMenuRight>
            <a href="./EditProjects">
              {intl.get("menu_direito.terceiro_botao.primeiro")}
            </a>
            <a href="./EditProjects">
              {intl.get("menu_direito.terceiro_botao.segundo")}
            </a>
          </TextMenuRight>
        </ContIcons>
        <ContIcons>
        ...
        <ContIcons>
          ...
          <TextMenuRight>
            <a href="./Dashboard">
              {intl.get("menu_direito.sexto_botao.primeiro")}
            </a>
            <a href="./Dashboard">
              {intl.get("menu_direito.sexto_botao.segundo")}
            </a>
          </TextMenuRight>
        </ContIcons>
      </ContainerMenuRight>
