...
import { ContIcons } from '../Menu/styleMenuRight';
import { Container, ContainerInfo, ContainerProject, 
        ContainerTitle, ContainerFiltro, Atualizar, ProjectsGrid, Center, Msg  } from './styles';
